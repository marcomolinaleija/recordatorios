...
addon_info = {
	...
	"addon_url": "https://github.com/marcomolinaleija/recordatorios",
	# URL for the add-on repository where the source code can be found
	"addon_sourceURL": "https://github.com/marcomolinaleija/recordatorios",
...
pythonSources = [
    ...
    'addon/globalPlugins/recordatorios/widgets/reminder_app.py',
    'addon/globalPlugins/recordatorios/widgets/reschedule_dialog.py',
    'addon/globalPlugins/recordatorios/widgets/tasks_dialog.py',
    'addon/globalPlugins/recordatorios/widgets/snooze_dialog.py',
    'addon/globalPlugins/recordatorios/widgets/incomplete_task_dialog.py',
    'addon/globalPlugins/recordatorios/widgets/config_panel.py',
